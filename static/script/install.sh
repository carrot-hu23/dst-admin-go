...
./steamcmd.sh +@sSteamCmdForcePlatformType linux +@sSteamCmdForceRegionCN shenzhen +force_install_dir ~/dontstarve_dedicated_server +login anonymous +app_update 343050 validate +quit
